<h1><?=VCDLanguage::translate('xml.confirm')?></h1>
<? 
    ...
    if (!is_array($xmltitles) || sizeof($xmltitles) == 0) {
        print "<p>".VCDLanguage::translate('xml.error')."</p>";
        
    } else {
    ?>
    
    <p><span class="bold"><? printf(VCDLanguage::translate('xml.contains'), sizeof($xmltitles))?></span>
    <br/><?=VCDLanguage::translate('xml.info1')?>
    <br/><br/>
    ...
    <? if (!$hasThumbs) { ?> 
    <p>
        <span class="bold" style="color:red"><?=VCDLanguage::translate('misc.attention')?></span><br/>
        <?=VCDLanguage::translate('xml.info2')?>
    	
        <br/><br/>
        
        
    	&nbsp;&nbsp;&nbsp;<?=VCDLanguage::translate('xml.thumbnails')?> &nbsp;  <input type="file" name="xmlthumbfile"/>
    	<input type="submit" value="<?=VCDLanguage::translate('misc.update')?>" name="thumbsupdate" id="thumbsupdate"/>
    ...
    <p><span class="bold"><?=VCDLanguage::translate('xml.list')?></span></p>
