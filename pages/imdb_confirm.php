...
<tr>
	<td class="header">IMDB <?=language::translate('M_INFO')?></td>
	<td class="header"><?=language::translate('M_DETAILS')?></td>
</tr>
<tr>
	...
	<tr>
		<td><?=language::translate('M_GRADE')?>:</td>
...
<!-- End IMDB Cast -->
	...
	<tr>
		<td class="strong" nowrap><?=language::translate('M_MEDIATYPE')?>:</td>
		<td>
		<? 
	...
	<br/>
	<input type="submit" value="<?=language::translate('X_CONFIRM')?>" class="buttontext" onclick="return val_IMDB(this.form)"/>
