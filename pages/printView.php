...
<?
	...
	if (strcmp($_GET['mode'], "text") == 0) {
		...
		print "<tr><td class=\"bold\" width=\"50%\">".VCDLanguage::translate('movie.title')."</td><td class=\"bold\">".VCDLanguage::translate('movie.category')."</td><td class=\"bold\">".VCDLanguage::translate('movie.year')."</td><td class=\"bold\">".VCDLanguage::translate('movie.media')."</td><td class=\"bold\">".VCDLanguage::translate('movie.date')."</td></tr>";
