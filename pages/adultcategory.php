<? 
	...
	if (isset($_GET['viewmode'])) {
		$imagemode = true;
		$viewbar = "(<a href=\"./?page=".$CURRENT_PAGE."&amp;category_id=".$cat_id."&amp;batch=".$batch."\">".language::translate('M_TEXTVIEW')."</a> / ".language::translate('M_IMAGEVIEW').")";		
	} else {
		$viewbar = "(".language::translate('M_TEXTVIEW')." / <a href=\"./?page=".$CURRENT_PAGE."&amp;category_id=".$cat_id."&amp;viewmode=img&amp;batch=".$batch."\">".language::translate('M_IMAGEVIEW')."</a>)";
	}
