...
<? 
	...
	<p><span class="bold"><? printf($language->show('EXCEL_RESULTS2'), sizeof($excelResults)) ?></span></p>
	<br/><br/>
	<table cellpadding="1" cellspacing="1" border="0" width="100%" class="displist">
	<tr>
		<td class="bold"><?=$language->show('X_STATUS')?></td><td class="bold"><?=$language->show('M_TITLE')?></td><td class="bold">Media Index</td>
	</tr>
	<?
