...
CREATE TABLE vcd_MetaData ( metadata_id INTEGER NOT NULL, record_id INTEGER NOT NULL, mediatype_id INTEGER NOT NULL, user_id INTEGER NOT NULL, type_id INTEGER NOT NULL, metadata_value VARCHAR(250) NOT NULL, PRIMARY KEY (metadata_id) )
