...
CREATE TABLE vcd_MetaData ( metadata_id INTEGER NOT NULL, record_id INTEGER NOT NULL, user_id INTEGER NOT NULL, type_id INTEGER NOT NULL, metadata_value VARCHAR(150) NOT NULL, PRIMARY KEY (metadata_id) )
CREATE TABLE vcd_MetaDataTypes ( metadata_type_id INTEGER NOT NULL, metadata_type_name VARCHAR NOT NULL, metadata_type_level INTEGER NOT NULL, PRIMARY KEY (metadata_type_id) )
