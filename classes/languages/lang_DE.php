...
'LOGIN_INFO'            => '<b>Nur</b> zum Ändern des Passwortes ausfüllen',
...
'REGISTER_DISABLED'     => 'Zur Zeit keine Registrierung möglich',
'REGISTER_OK' 			=> 'Registrierung war erfolgreich, Anmeldung ist freigeschaltet.',

/* User Properties */
'PRO_NOTIFY'            => 'Benachrichtigung über neu hinzugefügte Filme senden?',
...
'PRO_USE_INDEX'         => 'Index Feld für eigene Medien ID\'s verwenden?',
'PRO_SEEN_LIST'         => 'Eigene \'Gesehene Filme\' Liste verwalten',
'PRO_PLAYOPTION'        => 'Zusätzliche Abspieloptionen verwenden',
...
'SE_SELECTRSS'          => 'RSS feeds auswählen',
...
'M_NOPLOT'       	  	=> 'Keine Inhaltsangabe verfügbar',
'M_COVERS'          	=> 'CD Cover',
'M_NOCOVERS'         	=> 'Kein CD Cover verfügbar',
'M_AVAILABLE'          	=> 'Verfügbare Kopien',
'M_MEDIA'        	 	=> 'Medium',
'M_NUM'          		=> 'Num CD\'s',
'M_DATE'         	 	=> 'Datum',
'M_OWNER'        	 	=> 'Eigentümer',
'M_NOACTORS'        	=> 'Keine Schauspielerliste verfügbar',
'M_INFO'         		=> 'Film info',
...
'M_NOSCREENS'           => 'Kein Screenshot verfügbar',
'M_SHOW'        	 	=> 'Anzeigen',
'M_HIDE'        		=> 'Verstecken',
'M_CHANGE'       	 	=> 'Information ändern',
...
'M_SIMILAR'				=> 'Ähnliche Filme',
'M_MEDIAINDEX'			=> 'Medien ID',

/* IMDB */
'I_DETAILS'         	=> 'IMDB Details',
'I_PLOT'         		=> 'Inhaltsangabe',
'I_GALLERY'         	=> 'Foto Übersicht',
'I_TRAILERS'         	=> 'Trailers',
'I_LINKS'        	 	=> 'IMDB Links',
'I_NOT'           	 	=> 'Keine IMDB Info verfügbar',
...
'MY_JOIN'         		=> 'CD zusammenführen',
'MY_JOINMOVIES'         => 'Film zusammenführen',
'MY_JOINSUSER'         	=> 'Nutzer wälen',
'MY_JOINSMEDIA'         => 'Media Typ wählen',
'MY_JOINSCAT'         	=> 'Kategorie wählen',
'MY_JOINSTYPE'        	=> 'Aufgabe wählen',
'MY_JOINSHOW'        	=> 'Ergebnis anzeigen',
'MY_NORESULTS'          => 'Keine Ergebnisse verfügbar',
...
'MY_OVERVIEW'         	=> 'Übersicht',
'MY_INFO'        	 	=> 'Auf diesen Seiten steht alles über meine Filme.
                  Auf der rechten Seite sind die möglichen Aktionen aufgelistet.
                  Ausserdem gibt es eine Möglichkeit, die Filmkolektion als Excel Datei zur
...
'MAN_1COPY'          	=> 'Kopie',
'MAN_ADDACT'          	=> 'Schauspieler hinzufügen',
'MAN_ADDTODB'           => 'Schauspieler zur DB hinzufügen',
'MAN_SAVETODB'          => 'In die DB speichern',
'MAN_SAVETODBNCD'       => 'In die DB und CD speichern',
'MAN_INDB'          	=> 'Schauspieler in DB',
'MAN_SEL'         		=> 'Ausgewählte Schauspieler',
'MAN_STARS' 			=> 'Stars',
'MAN_BROWSE'			=> 'Browse for file location',
'MAN_ADDMEDIA'			=> 'Add...',

/* Add movies */
'ADD_INFO'          	=> 'Folgende Datenquellen stehen zur Verfügung',
'ADD_IMDB'          	=> 'Einen Film aus der Web auswählen',
'ADD_IMDBTITLE'       	=> 'Suchbegriff',
'ADD_MANUAL'          	=> 'Daten manuell eingeben',
'ADD_LISTED'          	=> 'Einen Film aus der lokalen Datenbank auswählen',
'ADD_XML'          		=> 'Eine XML-Datei importieren',
'ADD_XMLFILE'           => 'XML-Datei auswählen',
'ADD_XMLNOTE'           => '(Hinweis: Nur XML-Dateien, die von der VCDDB exportiert wurden (oder exakt deren Format haben)
                  können hier importiert werden. Die Export-Funktion steht unter \'Meine Filme\' zur Verfügung.
		  Manuelles editieren der XML-Dateien sollte vermieden werden.)',
'ADD_MAXFILESIZE'       => 'Max Dateigröße',
'ADD_DVDEMPIRE'       	=> 'Von DVD Empire (X-rated/Porno Filme) auswählen',
'ADD_LISTEDSTEP1'       => 'Schritt 1<br/>Den gewünschten Titel auswählen.',
'ADD_LISTEDSTEP2'       => 'Schritt 2<br/>Das passende Medium wählen.',
'ADD_INDB'          	=> 'Filme in VCD-DB',
'ADD_SELECTED'          => 'Ausgewählte Titel',
...
'ADD_NOTITLES'          => 'Kein anderer Nutzer hat Filme hinzugefügt',

/* Add from XML */
'XML_CONFIRM'           => 'XML Upload bestätigen',
'XML_CONTAINS'          => 'XML-Datei enthält %d Filme.',
'XML_INFO1'          	=> '\'Bestätigen\' um die Filme in die Datenbank einzutragen oder<br/>
                  \'Cancel\' zum Abbrechen.',
'XML_INFO2'          	=> 'Wenn die Coverbilder mit abgespeichert werden sollen, <b>müß</b> die entsprechende XML-Datei
		  vorliegen. Nachträgliches importieren der Cover-Bilder ist <b>nicht</b> möglich.<br/>
                  Wenn die XML-Datei vorliegt, einfach das Kästchen hierunter ankreuzen und im nächsten Schritt werden
		  die Coverbilder eingelesen.',
'XML_THUMBNAILS'      	=> 'Coverbilder aus der XML-Datei hunzufügen',
'XML_LIST'         	=> 'Vollständige Liste der Filme aus der XML-Datei',
'XML_ERROR'         	=> 'Keine Filme in der XML-Datei gefunden.<br/>Datei ist möglicherweise beschädigt oder einfach nur leer.
                     <br/>Verwenden sie eine von VCD-db exportierte XML-Datei..',
'XML_RESULTS'         	=> 'XML Upload Ergebnisse',
'XML_RESULTS2'          => 'Dies sind die Ergebnisse vom XML Import.<br/>Es wurden insgesamt %d Filme eingefügt.',
...
'EM_NOTICE'         	=> 'Rot markierte Darsteller sind momentan nicht in der VCD-DB eingetragen.
                  Durch Auswahl der Namen werden sie der Datenbank hinzugefügt und mit diesem Film verbunden.',
'EM_FETCH'       	  	=> 'Auch hinzufügen',

/* Loan System */
'LOAN_MOVIES'         	=> 'Diese Filme ausleihen',
'LOAN_TO'         		=> 'an',
'LOAN_ADDUSERS'         => 'Es müssen Ausleiher zum System hinzugefügt werden',
'LOAN_NEWUSER'          => 'Neue Ausleiher',
'LOAN_REGISTERUSER'     => 'Neuen Ausleiher hinzufügen',
'LOAN_NAME'        		=> 'Name',
'LOAN_SELECT'         	=> 'Ausleiher wählen',
...
'LOAN_RETURN'         	=> 'Film zurück',
'LOAN_SUCCESS'          => 'Film erfolgreich ausgeliehen??hmpf',
'LOAN_OUT'      	   	=> 'Nicht zurück',
'LOAN_DATEIN'           => 'Zurück am',
...
'RSS_ADD'         	=> 'RSS feed hinzufügen',
'RSS_NOTE'        	=> 'Gebe die <strong>genaue Addresse</strong> der VCD Gegenstelle an.<br/>
                  Wenn dort RSS feeds eingeschltet sind, sind diese Feeds auch hier verfügbar
                  und werden natuerlich auch angezeigt.',
'RSS_FETCH'        	=> 'RSS Liste holen',
'RSS_NONE'         	=> 'Keine RSS feeds hinzugef&uumkl;gt.',
'RSS_FOUND'        	=> 'Folgende RSS feeds wurden gefunden, welche sollen hinzugefügt werden:',
'RSS_NOTFOUND'          => 'Kein RSS feed gefunden',


/* Wishlist */
'W_ADD'            	=> 'Zu meiner Wunschliste hinzufügen',
...
'MAIL_RETURNMOVIES1'    => 'Hallo %s, wollte dich nur mal erinnern, mir meine Filme zurückzugeben.\n
                     	Das ist die Liste:\n\n',
...
'MAIL_REGISTER'         => '%s, Registrierung erfolgreich.\nUsername ist %s , Passwort ist %s.\n\n
		      Nach dem Einloggen ist das Passwort jederzeit änderbar.\n
...
'PLAYER_NOTE'		=> 'Absoluter Pfad des Players.
                     Der Ploayer muss Commandline-Argumente akzeptieren wie z.B. BSPlayer für Win32 oder MPlayer für Linux.<br/>
...
/* Misc keywords */
'X_CONTAINS'		=> 'enthält',
'X_GRADE'		=> 'IMDB Bewertung höher als',
'X_ANY'			=> 'Alle',
...
'X_MOVIES'		=> 'Films',
'X_NOCATS'		=> 'Keine Filme verfügbar.',
