...
'MENU_CATEGORIES'       => 'Film kategori�n',
...
'M_AVAILABLE'          	=> 'Beschikbare kopi�n',
'M_MEDIA'         		=> 'Medium',
'M_NUM'          		=> 'Num CD\'s',
...
'ADD_XML'          		=> 'Voeg films toe vanuit ge�xporteerd XML-bestand',
'ADD_XMLFILE'           => 'Selecteer XML-bestand om te importeren',
'ADD_XMLNOTE'           => '(<u>Waarschuwing:</u> alleen XML-bestanden die werden ge�xporteerd vanuit een andere VCD-db installatie
                  kunnen worden gebruikt om je films hier te importeren. Je kunt je films exporteren
                  vanuit de "Mijn films" sectie. Probeer handmatige aanpassingen van de ge�xporteerde
...
'XML_INFO2'          	=> 'Als je thumbnails (posters) will meenemen met de films die je met deze keuze gaat
                  ...
                  Posters kunnen niet worden ge�mporteerd nadat je gereed bent met importeren van je films vanuit het huidige XML-bestand.
...
'XML_ERROR'         	=> 'Geen titels gevonden in XML-bestand.<br/>Bestand kan beschadigd zijn, of het is gewoon een leeg bestand.
                     <br/>Zorg ervoor dat je <u>zeker</u> het XML-bestand kiest dat werd ge�xporteerd vanuit VCD-db..',
'XML_RESULTS'         	=> 'XML upload resultaten.',
'XML_RESULTS2'          => 'Dit zijn de resultaten van je XML import.<br/>In totaal werden %d films ge�mporteerd.',


/* Add from DVD Empire */
'EM_INFO'         		=> 'Informatie van AdultDVDEmpire.com ....',
'EM_DESC'         		=> 'DVDEmpire beschrijving',
'EM_SUBCAT'         	=> 'Adult categorie�n',
...
'RSS_NOTE'        		=> 'Enter de <strong>excacte url</strong> van de VCD database van je vriend/kennis.<br/>
                  ...
                  feeds waarin je ge�nteresseerd bent selecteren en weergeven op jouw pagina.',
